...
KC_LEFT, KC_DOWN,      KC_NO,        LSFT_T(KC_LANG2), LT(1, KC_SPC), KC_ESC, KC_TAB, LT(2, KC_ENT),  LSFT_T(KC_LANG1), KC_NO,        KC_UP,        KC_RIGHT
    ),
    [_LOWER] = LAYOUT(
...
KC_TRNS, KC_TRNS, KC_TRNS, KC_BSPC, KC_NO,   KC_TRNS, KC_RPRN, KC_RPRN,  KC_RPRN,  KC_RPRN, KC_RPRN, RESET
   ),
};
