...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KC_LEFT,	KC_Z,	KC_X,	KC_C,	KC_V,	KC_B,   MBTN1, MBTN3,   KC_N,	KC_M,	KC_COMM,	KC_DOT,	KC_SLSH,	KC_RIGHT,
				KC_DOWN, LSFT_T(KC_LANG2),	LT(1, KC_SPC),    MBTN2,    LT(2, KC_ENT),	LSFT_T(KC_LANG1),	KC_UP
    ),
    [_LOWER] = LAYOUT(
