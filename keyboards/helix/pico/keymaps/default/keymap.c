...
[_QWERTY] = LAYOUT( \
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, _______,                   _______, _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, \
      _______, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, _______, _______, _______, _______, _______, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD \
      )
};
